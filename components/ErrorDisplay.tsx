...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = React.memo(({ message, onClear }) => {
  ...
  return (
    <div
      className="my-4 p-4 bg-red-100 border-l-4 border-red-500 text-red-800 rounded-r-lg shadow-md flex items-center justify-between animate-fade-in no-print"
      role="alert"
    >
